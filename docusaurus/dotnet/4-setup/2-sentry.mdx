...
In the code examples, copy the DSN value passed to `Sentry.Init`, and add it to your ConfigMap in Openshift.

```yaml title="ConfigMap"
data:
  SENTRY_DSN: 'https://<long-random-string>@sentry.intility.no/<int>'
```
