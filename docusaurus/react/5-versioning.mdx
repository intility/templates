...
When it determines that your app should be versioned, it will create a pull request to version the app. The pull request will include:

- A new version number in the `package.json` file
- A changelog entry in the `CHANGELOG.md` file
- Bump the version in `k8s/overlays/production/kustomization.yaml`
